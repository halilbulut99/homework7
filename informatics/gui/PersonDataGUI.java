...
public class PersonDataGUI {
	...
	JTable table;
	copyStudentDataModel personDataModel;
	...
	public void createAndShowGUI() {
		...
		personDataModel = new copyStudentDataModel(people);
	...
	public void filterTable(int intValue, JTable table, Person[] people) {
		...
		switch (intValue) {
			case 1: 
				this.personDataModel = new copyStudentDataModel(filterData(people, Student.class));
				break;
			case 2: 
				this.personDataModel = new copyStudentDataModel(filterData(people, Professor.class));
				break;
			case 3: 
				this.personDataModel = new copyStudentDataModel(filterData(people, Person.class));
				break;
		}
